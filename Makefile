...
#    Updated: 2025/04/21 14:35:39 by tchow-so         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_EXECUTER	= $(addprefix $(EXECUTER_DIR)/, exec_ast.c exec_ast_pipe.c \
...
SRC_EXPANDER	= $(addprefix $(EXPANDER_DIR)/, expand_env_handle.c \
	...
	wildcards_check_match.c wildcards_expand.c wildcards_utils.c \
	wildcards_utils2.c)
