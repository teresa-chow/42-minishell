...
void	expand(t_data *data, t_word *word)
{
	...
	last_part = ft_strchr(param, find_no_alnum(param)); //// fix: i cant have '"'. if found '.!"', i dont want "
	if (*last_part == '"')
		last_part = NULL;
	...
	if (env_var)
	{												//$OLDPWD.!					
		////// if last part is valid, i have to join last part to expansion   ----------- like: /home/carlaugu.!
